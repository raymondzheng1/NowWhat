---
title: How do I ask for a public housing transfer in Victoria?
description: >-
  How to ask for a public housing transfer in Victoria, and how to appeal if you
  disagree.
question: How do I ask for a public housing transfer in Victoria?
answer: >-
  You can ask to move to a different public housing home through your local
  housing office. This is called a transfer. If you disagree with a decision
  about your transfer, you can appeal it for free through the Housing Appeals
  Office.
...
sources:
  ...
  - >-
    Victorian housing department — Appeal a decision (Housing Appeals Office) —
    housing.vic.gov.au
...
A transfer means asking to move from one public housing property to another. You might want to move because your household size has changed, for health reasons, or because of safety concerns like family violence.

If your transfer request is not approved, you have the right to know why. The housing office must give you a letter explaining the decision.

## How do I challenge a transfer decision I disagree with?
...
You can argue that the housing department did not apply its own policies and procedures correctly. Evidence that could support your appeal includes:

- Documents showing you meet the housing rules (for example, income, residency, medical or disability evidence)
