...
whatRelates:
  ...
  - Nothing in the letter shows the signer was allowed to decide.
whatItIsNot: >-
  It does not mean staff can never act for a minister. Many powers are used
  that way every day. The question is what the Act requires.
usedIn:
  - judicial-review
test: >-
...
elements:
  ...
  - id: authority-to-sign
    name: Whether the signer was authorised
    layPrompt: Does anything show the signer was allowed to decide?
sources:
