---
id: objective-jurisdictional-fact
name: A fact the power depended on
plainName: A fact the law required was not there
...
leadingCases:
  - name: >-
    ...
    pinpoint: ''
    explains: >-
      A power that depends on a country meeting set conditions needs those
...
Some powers are switched on by a fact. If the fact is not there, the power was never
switched on. This is one of the few grounds where a court will look at the fact itself
