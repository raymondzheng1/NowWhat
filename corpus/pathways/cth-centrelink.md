...
pathways:
  - name: "Ask Services Australia to explain or look at the decision again (internal review)"
    ...
    deadline: "You can usually ask for an internal review, but asking sooner can matter for any back-payment. A time limit may apply to some steps — confirm the current rule and how it is counted for your decision."
    deadlineDays: null
    deadlineVerified: false
    howToStart: "tell Services Australia you disagree and ask for the decision to be reviewed by an Authorised Review Officer"
    cost: "free"
    source: "servicesaustralia.gov.au — reviews and appeals"
  - name: "Apply to the Administrative Review Tribunal (ART) for external review"
    body: "Administrative Review Tribunal (ART)"
    deadline: "There is a time limit to apply to the ART for many decisions. Confirm the current period and how it is counted before you apply, because missing it can limit your options."
    deadlineDays: null
    deadlineVerified: false
...
groundsOrCriteria:
  ...
  - "you think the rules were applied incorrectly to your situation"
  - "your circumstances were not properly taken into account"
evidenceChecklist:
  - "the decision letter or the debt notice, including any reference number"
  - "payslips, bank statements or records showing your income and the dates"
...
getHelp:
  ...
  - service: "Services Australia — reviews and appeals"
    who: "ask for a decision to be reviewed"
...
review by Services Australia, done by an Authorised Review Officer. If you still disagree,
