...
title: "I disagree with a public or community housing decision in Victoria"
jurisdiction: Victoria
status: verified
decisionTypes:
  - application not approved
  - priority access not granted
  - transfer refused
  - rebate cancelled
  - rental rebate assessment
  - removal from the Victorian Housing Register
...
reviewable:
  value: "yes"
  basis: "Most social-housing decisions can be challenged, but the route depends on the type of decision: housing-application decisions go to the Housing Appeals Office, while an eviction goes to VCAT."
  verified: true
pathways:
  - name: "Ask for a housing appeal (for decisions about your application, priority, transfer or rebate)"
    body: "the Housing Appeals Office (an independent reviewer within the housing department)"
    deadline: "There is no strict published deadline, but lodge as soon as you can. If the first review does not fix it, it automatically goes to the Housing Appeals Office for an independent review."
    deadlineDays: null
    deadlineVerified: false
    howCounted: "as soon as possible after the decision"
    howToStart: "talk to your local housing office first, then lodge a housing appeal online, by post or by phone"
    cost: "free"
    source: "housing.vic.gov.au — appeal a decision; Housing Act 1983 (Vic)"
  - name: "Challenge a notice to vacate (eviction) at VCAT"
  ...
  - name: "Community housing: complain to the provider, then the Housing Registrar"
    body: "your community housing provider, then the Victorian Housing Registrar"
    deadline: "Use the provider's complaints process first. If you are not happy with the outcome, you can ask the Housing Registrar to look at it."
    deadlineDays: null
    deadlineVerified: false
...
evidenceChecklist:
  - "the decision letter or notice, and the date you received it"
  - "documents showing you meet the housing rules, such as income, residency, or medical, disability or family-violence evidence"
  - "for an eviction: evidence of hardship — children or dependants, health, disability, family violence, how long you have lived there, and any plan to pay arrears"
  - "any letters between you and the housing office or provider"
getHelp:
  - service: "Tenants Victoria — Social Housing line"
    who: "free advice for public, community and rooming-house renters"
    phone: "1800 068 860"
    link: "https://tenantsvic.org.au"
  - service: "Justice Connect — Homeless Law"
    who: "free legal help for people at risk of homelessness, including evictions"
    phone: "1800 606 313"
...
sources:
  - "Housing Act 1983 (Vic) — legislation.vic.gov.au"
...
Social-housing problems split into two separate paths, and getting into the right one
matters. Decisions about a housing *application* — eligibility, priority, a transfer, or
a rebate — are reviewed by the **Housing Appeals Office** and have no strict deadline.
An *eviction* (a notice to vacate) is a tenancy matter under the Residential Tenancies
Act, goes to **VCAT**, and has a 30-day window to challenge it early. The 30-day window
is the time to challenge *early* — a renter can still argue the notice is invalid at the
possession hearing.
